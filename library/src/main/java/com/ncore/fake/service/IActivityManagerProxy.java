...
import com.ncore.core.system.DaemonService;
import com.ncore.core.system.user.BUserHandle;
import com.ncore.entity.AppConfig;
import com.ncore.entity.am.RunningAppProcessInfo;
import com.ncore.entity.am.RunningServiceInfo;
import com.ncore.fake.delegate.ContentProviderDelegate;
import com.ncore.fake.delegate.InnerReceiverDelegate;
import com.ncore.fake.delegate.ServiceConnectionDelegate;
import com.ncore.fake.frameworks.BActivityManager;
import com.ncore.fake.frameworks.BPackageManager;
import com.ncore.fake.hook.ClassInvocationStub;
import com.ncore.fake.hook.MethodHook;
import com.ncore.fake.hook.ProxyMethod;
import com.ncore.fake.hook.ScanClass;
import com.ncore.fake.service.base.PkgMethodProxy;
import com.ncore.fake.service.context.providers.ContentProviderStub;
import com.ncore.fake.service.context.providers.SystemProviderStub;
import com.ncore.proxy.ProxyManifest;
import com.ncore.proxy.record.ProxyBroadcastRecord;
import com.ncore.proxy.record.ProxyPendingRecord;
import com.ncore.utils.ArrayUtils;
import com.ncore.utils.ComponentUtils;
import com.ncore.utils.FileUtils;
import com.ncore.utils.MethodParameterUtils;
import com.ncore.utils.Reflector;
import com.ncore.utils.Slog;
import com.ncore.utils.compat.ActivityManagerCompat;
import com.ncore.utils.compat.BuildCompat;
import com.ncore.utils.compat.ParceledListSliceCompat;
import com.ncore.utils.compat.TaskDescriptionCompat;
...
public class IActivityManagerProxy extends ClassInvocationStub {
    ...
    public static class getCurrentUser extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return BRUserInfo.get()._new(BActivityThread.getUserId(), "Ncore", BRUserInfo.get().FLAG_PRIMARY());
        }
    }
