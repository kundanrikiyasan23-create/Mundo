...
public class ProxyService extends Service {
    ...
    private void showNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), getPackageName() + ".Ncore_Proxy").setPriority(NotificationCompat.PRIORITY_MAX);
